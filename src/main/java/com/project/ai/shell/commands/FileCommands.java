...
//
//    /*
//    adding all files in database
//    */
//
//    @ShellMethod(key = "scan", value = "scans all files in the project")
...
//
//            for (String file : files) {
//                result.append("   scanned success").append(file).append("\n");
//                String fileContent = fileService.readFile(file);
//                documentList.add(new Document(fileContent));
//            }
...
//
//                    try {
//                        String fileContent = fileService.readFile(file.relativePath());
//                        documentList.add(new Document(fileContent));
//
//                    } catch (IOException e) {
